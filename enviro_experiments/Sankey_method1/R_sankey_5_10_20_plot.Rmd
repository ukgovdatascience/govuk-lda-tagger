...
df_10_20$source = df_10_20$source + 10
...
df_5_10$target = df_5_10$target + 10
df_10_20$target = df_10_20$target + 20
...
```{r}
sankeyNetwork(Links = links, Nodes = node, Source = "source2",
             Target = "target2", Value = "value", fontSize = 12, NodeID = "node", nodeWidth = 30) 
```

something wrong with nodes file. Try this sanktify function
```{r}
